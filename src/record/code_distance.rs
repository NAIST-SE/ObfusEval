...
pub struct CodeDistance {
    ...
    pub by_longest_common_substring: f32,
...
impl CodeDistance {
    pub fn new(elf_a: &PathBuf, elf_b: &PathBuf) -> CodeDistance {
        CodeDistance {
            ...
            by_longest_common_substring: CodeDistance::longest_common_substring(&elf_a, &elf_b),
        }
    }
}
...
impl CodeDistance {
    ...
    fn longest_common_substring(elf_a: &PathBuf, elf_b: &PathBuf) -> f32 {
        let a = Code::opcode(elf_a).join(" ");
        let b = Code::opcode(elf_b).join(" ");
        ...
        1.0 - lcs.substring_len as f32 / denominator
    }
}
...
mod tests {
    ...
    fn lcsubstr() {
        ...
        assert_eq!(CodeDistance::longest_common_substring(&elf_a, &elf_b), 0.95519894);
    }
